...
namespace Reface.AppStarter.Attributes
{
    ...
    /// 继承了该类型的 AOP 还必须标记 <see cref="ExplicitProxyAttribute"/> 特征。 <br />
    /// 
    /// 详情可参考 : https://github.com/ShimizuShiori/Reface.AppStarter.Proxy/blob/Future_MethodAttachment/docs/ProxyAttribute.md
    /// </summary>
